        ...
        .then((data) => {
          if (data) {
            const orderData = {
              ...
              delieverDate: convertDateForDatePicker(data.delieverDate),
            };
            setOrder(orderData);
          }
        })
      ...
      <div className="flex justify-between mb-6 space-x-4">
        <div className="w-1/3">
          ...
          <DatePicker
            ...
            granularity="day"
            className="custom-datepicker w-full px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600"
          />
        </div>
